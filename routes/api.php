...
Route::group(['namespace' => 'App'], function () {
	...
	Route::get('/driver/profile', 'CustomersController@getrideinfo');

	//Route::get('/driver/profile', 'CustomersController@getprofile');





	Route::put('/driver/profileupdate', 'CustomersController@updatecustomerinfo');

	Route::get('/driver/ride', 'CustomersController@getrideinfo');
	Route::get('/driver/rider', 'CustomersController@getridestatus');




	Route::get('/driver', 'CustomersController@getdriverallinfo');





	Route::put('/driver/imageupdate', 'CustomersController@imageupdate');


	Route::post('validatedecoder', 'CustomersController@validatedecoder');
	...
	Route::post('/registerdriver', 'CustomersController@processregistrationdriver');
	//verify driver
	Route::post('/verify-driver-mobile', 'CustomersController@verifydrivermobile');



	//processregistration url
	Route::post('/verify-mobile', 'CustomersController@verifymobile');

	Route::get('/getuserinfo/{id}', 'CustomersController@getuserinfo');
	...
	//Driver login
	Route::post('/logindriver', 'CustomersController@logindriver');
	...
	*/
	...
	Route::post('/getpackage', 'LocationController@getpackage');

	Route::post('/getmeters', 'LocationController@getmeters');





	Route::post('/getgotvpackage', 'LocationController@getgotvpackage');
	...
	Route::post('/verifytranx', 'CustomersController@verifytranx');


	Route::post('/verifytranxenugu', 'CustomersController@verifytranxenugu');
	...
	Route::post('/paymenturl777', 'CustomersController@paymenturl');


	Route::post('/decoderpaymenturl', 'CustomersController@decoderpaymenturl');
	...
	*/
	...
	//add To order
	Route::post('/setbudget', 'OrderController@setbudget');
	...
	//get Coupon
	Route::post('/getmonnify', 'OrderController@getmonnify');
	Route::post('/reservemonnify', 'OrderController@reservemonnify');
	...
	*/
	...
	//get banners
	Route::post('/getoldmeters', 'CustomersController@getoldmeters');


	Route::post('/getaccount', 'CustomersController@getaccount');


	Route::post('/getuserPKaccount', 'CustomersController@getuserPKaccount');

	Route::post('/chargePaymentPK', 'CustomersController@chargePaymentPK');
